...
# of the TTCN-3 Test Executor version 7/CAX 105 7730 R2A
# for imc (imc@imc) on Tue Mar 16 17:15:40 2021
...
TTCN3_MODULES = hello_world.ttcn MyExample.ttcn
...
# this project:
GENERATED_SOURCES = hello_world.cc MyExample.cc
GENERATED_HEADERS = hello_world.hh MyExample.hh
...
GENERATED_OBJECTS = hello_world.o MyExample.o

USER_OBJECTS = PCOType.o

# Other files of the project (Makefile, configuration files, etc.)
# that will be added to the archived source files:
OTHER_FILES = MyExample.cfg MyExample2.cfg Makefile
